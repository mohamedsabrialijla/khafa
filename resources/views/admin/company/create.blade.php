...
@section('title'){{"Create New Company"}}@endsection
@section('page-style')
...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li><a href="{{url(app()->getLocale().'/admin/company')}}"><i class="fa fa-th"></i> Companies</a></li>
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                @endif
                <form class="form-horizontal" method="post" action="{{url(app()->getLocale().'/admin/company')}}"
                     ...
                     <div class="box-body">
                        ...
                        <div class="row text-center">
                            <div class="col-sm-6 col-md-offset-3">
                                ...
                                <label class="control-label">{{"Logo Defaulte : "}}</label>
